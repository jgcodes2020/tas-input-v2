...
namespace tasdi2 {
  ButtonFrame::ButtonFrame() : Gtk::Frame("Buttons"), grid() {
      ...
      GTK_STYLE_PROVIDER_PRIORITY_APPLICATION);
    {
      ...
      buttons[BTN_L].set_css_classes({"btfr-trigger"});
      ...
      buttons[BTN_Z].set_css_classes({"btfr-trigger"});
      ...
      buttons[BTN_R].set_css_classes({"btfr-trigger"});
